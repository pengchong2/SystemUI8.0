...
public class QSFragment extends Fragment implements QS {
    ...
    private void updateQsState() {
        ...
        Log.d("qspanel","11111updateQsState ="+mHeader.getVisibility());
        mHeader.setVisibility((mQsExpanded || !mKeyguardShowing || mHeaderAnimating)
                ? View.VISIBLE
                : View.INVISIBLE);
        Log.d("qspanel","2222updateQsState ="+mHeader.getVisibility());
    ...
    public int getDesiredHeight() {
        if (mQSCustomizer.isCustomizing()) {
            Log.d(TAG,"mQSCustomizer.isCustomizing() = "+mQSCustomizer.isCustomizing());
        ...
        if (mQSDetail.isClosingDetail()) {
            ...
            Log.d(TAG,"mQSDetail.isClosingDetail() = "+panelHeight + getView().getPaddingBottom());
            return panelHeight + getView().getPaddingBottom();
        } else {
            Log.d(TAG,"else getView().getMeasuredHeight() = "+getView().getMeasuredHeight());
    ...
    public void setHeightOverride(int desiredHeight) {
        Log.d(TAG,"setHeightOverride desiredHeight = "+desiredHeight);
