...
public class CarStatusBar extends StatusBar implements
    ...
    private View flyNavigationBarView;
    ...
    protected void createNavigationBar() {
        ...
        flyNavigationBarView = View.inflate(mContext,R.layout.navigation_bar_fly_naviview,null);
     ...
     //   FlyaudioSystemUI.getInstance().setNavigationBarViewRoot((FrameLayout)flyNavigationBarView);
        ...
        FlyaudioSystemUI.getInstance().setNewNavigationBarViewRoot((FrameLayout)flyNavigationBarView,mContext);
		...
		mWindowManager.addView(flyNavigationBarView, lp);
