...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void makeStatusBarView() {
        ...
        updateDisplaySize(); // populates mDisplayMetric
        updateResources();
        updateTheme();
        ...
        if (container != null) {
            ...
            ExtensionFragmentListener.attachExtensonToFragment(container, QS.TAG, R.id.qs_frame,
                    Dependency.get(ExtensionController.class).newExtension(QS.class)
                            .withPlugin(QS.class)
                            .withFeature(
                                    PackageManager.FEATURE_AUTOMOTIVE, () -> new QSFragment())
        ...
        Log.d(TAG,"StatusBar container = "+container.getHeight());
    ...
    protected View.OnTouchListener getStatusBarWindowTouchListener() {
        return (v, event) -> {
             Log.d("pc","StatusBar View.OnTouchListener");
    ...
    public void clearAllNotifications() {
        ...
        Log.d("qspanel","numChilder = "+numChildren);
        final ArrayList<View> viewsToHide = new ArrayList<View>(numChildren);
        final ArrayList<ExpandableNotificationRow> viewsToRemove = new ArrayList<>(numChildren);
        for (int i = 0; i < numChildren; i++) {
            final View child = mStackScroller.getChildAt(i);
            if (child instanceof ExpandableNotificationRow) {
                Log.d("qspanel","child is ExpandableNotificationRow");
                ExpandableNotificationRow row = (ExpandableNotificationRow) child;
                boolean parentVisible = false;
                boolean hasClipBounds = child.getClipBounds(mTmpRect);

                Log.d("qspanel","haha");
                Log.d("qspanel","mStackScroller.canChildBeDismissed(child) = "+mStackScroller.canChildBeDismissed(child));
                if (mStackScroller.canChildBeDismissed(child)) {
                    ...
                    if (child.getVisibility() == View.VISIBLE
                        ...
                        && (!hasClipBounds || mTmpRect.height() > 0)) {
                    Log.d("qspanel","parentVisible = true");
                    parentVisible = true;
                }
        ...
        if (viewsToRemove.isEmpty()) {
            Log.d("qspanel","viewsToRemove.isEmpty()");
    ...
    boolean panelsEnabled() {
        Log.d("statusbar","mDisabled1 = "+mDisabled1+" StatusBarManager.DISABLE_EXPAND ="+StatusBarManager.DISABLE_EXPAND+" ONLY_CORE_APPS = "+ONLY_CORE_APPS);
        Log.d("statusbar","mDisabled1 & StatusBarManager.DISABLE_EXPAND = "+( mDisabled1 & StatusBarManager.DISABLE_EXPAND) );
        //return  true;
    ...
    void makeExpandedVisible(boolean force) {
        ...
        Log.d(TAG,"makeExpandedVisible force = "+force+" mExpandedVisible = "+mExpandedVisible+" panelEnable = "+panelsEnabled());
