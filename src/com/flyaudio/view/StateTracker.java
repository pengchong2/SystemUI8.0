...
//    private boolean mInTransition = false;
    private final String TAG = "StateTracker";
    private final boolean DeBug = true;
    protected static boolean mInTransition = false;
    ...
    public final void toggleState(Context context) {
    	if (DeBug)Log.d(TAG,"wifi toggleState" +"currentState = "+  getTriState(context) );
        ...
        switch (currentState) {
            ...
            case PowerButton.STATE_DISABLED:
                newState = true;
                break;
            case PowerButton.STATE_UNKNOWN:
                newState = true;
                mInTransition = false;
                break;
        ...
        if (DeBug)Log.d(TAG,"mInTransition == "+  mInTransition);
        if (mInTransition) {
    ...
    protected final void setCurrentState(Context context, int newState) {
        ...
        if (DeBug)Log.d(TAG,"setCurrentState  newState  =  "  +   newState);
        switch (newState) {
            case PowerButton.STATE_DISABLED:
                mInTransition = false;
                mActualState = false;
