...
public class QSContainerImpl extends FrameLayout {
    ...
    private String TAG = "QSContainerImpl";
    @Override
   ...
   protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG,"height = "+height+" topMargin = "+layoutParams.topMargin
                +" bottomMargin = "+layoutParams.bottomMargin+" mQSPanel.getMeasuredHeight() = "+mQSPanel.getMeasuredHeight());
