...
public class PhoneStatusBarView extends PanelBar {
    ...
    public void onPanelPeeked() {
        super.onPanelPeeked();
        Log.d(TAG,"onPanelPeeked makePanelVisible");
    ...
    public void onPanelCollapsed() {
        ...
        Log.d(TAG,"onPanelCollapsed makePanelInvisible");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.d(TAG,"onTouchEvent barConsumedEvent = "+barConsumedEvent);
    ...
    public void panelScrimMinFractionChanged(float minFraction) {
        Log.d(TAG,"panelScrimMinFractionChanged minFraction = "+minFraction+" mMinFraction = "+mMinFraction);
    ...
    public void panelExpansionChanged(float frac, boolean expanded) {
        ...
        Log.d(TAG,"panelExpansionChanged frac = "+frac+" expanded = "+expanded);
        mPanelFraction = frac;
        updateScrimFraction();
    }
