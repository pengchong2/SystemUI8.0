...
public abstract class PanelView extends FrameLayout {
    ...
    private void runPeekAnimation(long duration, float peekHeight, boolean collapseWhenFinished) {
        ...
        Log.d(TAG,"mHeightAnimator = "+mHeightAnimator+" mPeekAnimator = "+mPeekAnimator);
        ...
        mPeekAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (!mCancelled && collapseWhenFinished) {
                    Log.d(TAG,"postOnAnimation mPostCollapseRunnable");
    ...
    public PanelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG,"PanelView Constructor");
        ...
        mNotificationsDragEnabled = getResources().getBoolean(R.bool.config_enableNotificationShadeDrag);
        mNotificationsDragEnabled = true;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.d(TAG,"PanelView onTouchEvent");
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                Log.d(TAG,"x = "+x+" y = "+y+" mExpandedHeight = "+mExpandedHeight);
               ...
               trackMovement(event);
                if (!mGestureWaitForTouchSlop || (mHeightAnimator != null && !mHintAnimationRunning)
                    ...
                    mTouchSlopExceeded = (mHeightAnimator != null && !mHintAnimationRunning)
                            || mPeekAnimator != null;
                    Log.d(TAG,"cancleHeightAnimator");
            ...
            case MotionEvent.ACTION_POINTER_UP:
                ...
                Log.d(TAG,"upPointer = "+upPointer+" mTrackingPointer = "+mTrackingPointer);
                if (mTrackingPointer == upPointer) {
                    ...
                    Log.d(TAG,"newY = "+newY+" newX = "+newX+" mExpandedHeight = "+mExpandedHeight);
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                if (mStatusBar.getBarState() == StatusBarState.KEYGUARD) {
                    Log.d(TAG,"mstatusbar.state is keyguard");
                    mMotionAborted = true;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.d(TAG,"y = "+y+" mInitialTouchY = "+mInitialTouchY);
                // If the panel was collapsed when touching, we only need to check for the
                // y-component of the gesture, as we have no conflicting horizontal gesture.
                Log.d(TAG,"Math.abs(h) = "+Math.abs(h)+" mTouchSlop = "+mTouchSlop+" Math.abs(x - mInitialTouchX) = "+Math.abs(x - mInitialTouchX)+" mIgnoreXTouchSlop ="+mIgnoreXTouchSlop);
                if (Math.abs(h) > mTouchSlop
                    ...
                    if (mGestureWaitForTouchSlop && !mTracking && !mCollapsedAndHeadsUpOnDown) {
                       if (!mJustPeeked && mInitialOffsetOnTouch != 0f) {
                        ...
                        Log.d(TAG,"move onTrackingStarted");
                        cancelHeightAnimator();
                        onTrackingStarted();
                    }
                }
                ...
                if (!mJustPeeked && (!mGestureWaitForTouchSlop || mTracking) &&
                        !isTrackingBlocked()) {
                    Log.d(TAG,"on touch move setExpandedHeightInternal newHeight = "+newHeight);
    ...
    protected void startExpandMotion(float newX, float newY, boolean startTracking,
        ...
        if (startTracking) {
            mTouchSlopExceeded = true;
            Log.d(TAG,"startExpandMotion = "+mInitialOffsetOnTouch);
    ...
    private void endMotionEvent(MotionEvent event, float x, float y, boolean forceCancel) {
        ...
        if ((mTracking && mTouchSlopExceeded)
            ...
            Log.d(TAG,"endMotionEvent fliing");
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        Log.d(TAG,"PanelView onInterceptTouchEvent");
        if (mInstantExpanding || !mNotificationsDragEnabled || mTouchDisabled
                || (mMotionAborted && event.getActionMasked() != MotionEvent.ACTION_DOWN)) {
            Log.d(TAG,"mInstantExpanding = "+mInstantExpanding+" mNotificationsDragEnabled = "+mNotificationsDragEnabled);
            Log.d(TAG,"mTouchDisabled = "+mTouchDisabled+" = "+(mMotionAborted && event.getActionMasked() != MotionEvent.ACTION_DOWN));
            return false;
        }
        ...
        Log.d(TAG,"scrolledToBottom = "+scrolledToBottom);
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (mAnimatingOnDown && mClosing && !mHintAnimationRunning
                    ...
                    cancelPeek();
                    mTouchSlopExceeded = true;
                    Log.d(TAG," 1 onInterceptTouchEvent  = true");
                    return true;
                }
                mInitialTouchY = y;
                mInitialTouchX = x;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (scrolledToBottom || mTouchStartedInEmptyArea || mAnimatingOnDown) {
                    ...
                    if ((h < -mTouchSlop || (mAnimatingOnDown && hAbs > mTouchSlop))
                        ...
                        Log.d(TAG," 2 onInterceptTouchEvent  = true");
                        return true;
                    }
                }
                break;
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        Log.d(TAG,"PanelView onConfigurationChanged");
    ...
    protected void fling(float vel, boolean expand, float collapseSpeedUpFactor,
        ...
        cancelPeek();
        Log.d(TAG,"fling 2.5 expand = "+expand+" maxpanelh = "+getMaxPanelHeight());
    ...
    protected void flingToHeight(float vel, boolean expand, float target,
        ...
        Log.d(TAG,"flingToHeight target = "+target);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (clearAllExpandHack && !mCancelled) {
                    Log.d(TAG,"onAnimationEnd  getmaxPanelHeight = "+getMaxPanelHeight());
    ...
    protected void onAttachedToWindow() {
        ...
        Log.d(TAG,"PanelView onAttachedToWindow");
    ...
    public void setExpandedHeight(float height) {
        ...
        Log.d(TAG,"setExpandedHeight height = "+ (height + getOverExpansionPixels()));
    ...
    protected void onLayout (boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.d(TAG,"PanelView onLayout");
        mStatusBar.onPanelLaidOut();
        requestPanelHeightUpdate();
        mHasLayoutedSinceDown = true;
        if (mUpdateFlingOnLayout) {
            abortAnimations();
            Log.d(TAG,"onLayout  fling");
    ...
    protected void requestPanelHeightUpdate() {
        ...
        Log.d(TAG,"requestPanelHeightUpdate currentMaxPanelHeight = "+currentMaxPanelHeight+" mExpandedHeight = "+mExpandedHeight);
        Log.d(TAG,"isFullyCollapsed = "+isFullyCollapsed()+" currentMaxPanelHeight = "+currentMaxPanelHeight+" mExpandedHeight = "+mExpandedHeight);
        if (isFullyCollapsed()) {
            return;
        }
    ...
    public void setExpandedHeightInternal(float h) {
        ...
        Log.d(TAG,"setExpandedHeightInternal mExpandedHeight = "+mExpandedHeight);
    ...
    public void cancelPeek() {
        ...
        if (cancelled) {
            ...
            Log.d(TAG,"cancelPeek notifyBarPanelExpansionChanged");
            notifyBarPanelExpansionChanged();
        }
    }
    ...
    public void instantCollapse() {
        ...
        if (mInstantExpanding) {
            mInstantExpanding = false;
            Log.d("panelbar","instantCollapse notifyBarPanelExpansionChanged");
            notifyBarPanelExpansionChanged();
        }
    }
    ...
    private void startUnlockHintAnimationPhase2(final Runnable onAnimationFinished) {
        ...
        Log.d(TAG,"startUnlockHintAnimationPhase2 maxHeight = "+getMaxPanelHeight());
    ...
    private ValueAnimator createHeightAnimator(float targetHeight) {
        ...
        Log.d(TAG,"createHeightAnimator mExpandedHeight = "+mExpandedHeight+"  targetHeight = "+targetHeight);
